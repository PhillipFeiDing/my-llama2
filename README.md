...
> This is my personal project to build upon Llama 2. This repository is cloned and modified from [llama](https://github.com/facebookresearch/llama) GitHub repository by Meta Platforms Inc, branched from commit hash 82ce861078ce1d2a1ac17db15bda3604c684ccbe.

> See a section at the end for additional work I developed upon it.
...
A working conda environment setup requirement is available in `requirements-base.txt`. Open it and set up your Pytorch / CUDA environment before running the above command.
